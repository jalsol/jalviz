...
/**
 * @brief The GUI circular linked list container
...
public:
    ...
    /**
     * @brief Construct a new Gui Circular Linked List object
    ...
    /**
     * @brief Updates the GUI circular linked list
     */
    void update() override;

    /**
     * @brief Renders the GUI circular linked list
     */
