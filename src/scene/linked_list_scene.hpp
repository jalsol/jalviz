#ifndef SCENE_LINKED_LIST_SCENE_HPP_
...
class LinkedListScene : public internal::BaseScene {
private:
    ...
    gui::GuiLinkedList<int> m_list{
        gui::GuiNode<int>{1},
        gui::GuiNode<int>{2},
        gui::GuiNode<int>{3},
    };
    core::DoublyLinkedList<gui::GuiLinkedList<int>> m_sequence;
...
public:
    ...
    LinkedListScene(LinkedListScene&&) = delete;
    LinkedListScene& operator=(const LinkedListScene&) = delete;
    LinkedListScene& operator=(LinkedListScene&&) = delete;
    ~LinkedListScene() override = default;

    static LinkedListScene& get_instance();
...
#endif  // SCENE_LINKED_LIST_SCENE_HPP_
